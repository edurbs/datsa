...
public class AuthorizationServerConfig {
    ...
    @Bean
    public ProviderSettings providerSettings(DatsaSecurityProperties properties){
    ...
    public RegisteredClientRepository registeredClientRepository(PasswordEncoder passwordEncoder){
        RegisteredClient datsaBackEnd = RegisteredClient
                .withId("1")
                .clientId("datsa-backend")
        ...
        RegisteredClient datsaWeb = RegisteredClient
                .withId("2")
                .clientId("datsa-web")
        ...
        RegisteredClient datsaAnalytics = RegisteredClient
                .withId("3")
                .clientId("datsaAnalytics")
                .clientSecret(passwordEncoder.encode("web123"))
                .clientAuthenticationMethod(ClientAuthenticationMethod.CLIENT_SECRET_BASIC)
                .authorizationGrantType(AuthorizationGrantType.AUTHORIZATION_CODE)
                .scope("READ").scope("WRITE")
                ...
                .clientSettings(ClientSettings.builder()
                        ...
                        .build())
                .build();
        return new InMemoryRegisteredClientRepository(Arrays.asList(datsaBackEnd, datsaWeb, datsaAnalytics));
    }
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> jwtCustomizer(UserRepository userRepository){
        return  context -> {
            ...
            if (authentication.getPrincipal() instanceof User) {
                ...
                MyUser myUser = userRepository.findByEmail(user.getUsername()).orElseThrow();
                Set<String> authorities = new HashSet<>();
                for (GrantedAuthority authority : user.getAuthorities()) {
                    authorities.add(authority.getAuthority());
                }
                context.getClaims().claim("user_id", myUser.getId().toString());
